...
const DieuChinhTiLe = ({ TYPE_GAME }) => {
  const isXucXac10P = TYPE_GAME === LOAI_GAME.XUCXAC10P;
  ...
  return (
    <AdminSection
      title={isXucXac10P ? "Tỉ lệ trả thưởng VIP" : "Tỉ lệ trả thưởng"}
      subtitle={isXucXac10P ? "Điều chỉnh tỉ lệ theo từng cấp VIP" : "Cập nhật tỉ lệ trả thưởng cho game"}
    >
      {isXucXac10P && (
