const STORAGE_KEY = "corona_admin_alerts_v1";
const MAX_ITEMS = 50;

const emptyState = () => ({ items: [], readIds: [] });

export const loadAdminAlerts = () => {
...
export const saveAdminAlerts = (state) => {
