...
import ChiTietPhien from "@/components/admin/games/xucxac/ChiTietPhien";
import LichSuCuoc from "@/components/admin/games/xucxac/LichSuCuoc";
import { LOAI_GAME, convertLoaiGame } from "@/configs/game.config";
import { Box } from "@mui/material";
import { NextSeo } from "next-seo";
const ChiTiet = ({ ID }) => {
  const TYPE_GAME = LOAI_GAME.XUCXAC5P;
  ...
  return (
    <>
      ...
      <Layout>
        ...
        <Box sx={{ display: "flex", flexDirection: "column", gap: "16px", width: "100%", minWidth: 0, overflow: "hidden" }}>
