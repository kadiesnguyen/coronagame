...
const gameKeno10PRouters = require("./routers/game.keno.10p.routers");
const vipRouters = require("./routers/vip.routers");
...
const gameXucXac5PRouters = require("./routers/game.xucxac.5p.routers");
const gameXucXac10PRouters = require("./routers/game.xucxac.10p.routers");
...
app.use("/api/v1/games/keno10p", gameKeno10PRouters);
app.use("/api/v1/vip", vipRouters);
app.use("/api/v1/games/xucxac1p", gameXucXac1PRouters);
app.use("/api/v1/games/xucxac3p", gameXucXac3PRouters);
app.use("/api/v1/games/xucxac5p", gameXucXac5PRouters);
app.use("/api/v1/games/xucxac10p", gameXucXac10PRouters);
