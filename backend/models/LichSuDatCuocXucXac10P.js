...
const lichSuDatCuocXucXac10PSchema = new mongoose.Schema(
  {
    phien: {
  ...
  {
    collection: "LichSuDatCuocXucXac10P",
    timestamps: true,
  }
);

const LichSuDatCuocXucXac10P = mongoose.models.LichSuDatCuocXucXac10P || mongoose.model("LichSuDatCuocXucXac10P", lichSuDatCuocXucXac10PSchema);
module.exports = LichSuDatCuocXucXac10P;
