...
const lichSuDatCuocKeno10PSchema = new mongoose.Schema(
  {
    phien: {
  ...
  {
    collection: "LichSuDatCuocKeno10P",
    timestamps: true,
  }
);

const LichSuDatCuocKeno10P = mongoose.models.LichSuDatCuocKeno10P || mongoose.model("LichSuDatCuocKeno10P", lichSuDatCuocKeno10PSchema);
module.exports = LichSuDatCuocKeno10P;
