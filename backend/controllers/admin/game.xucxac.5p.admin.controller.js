...
class GameXucXac5PAdminController extends GameXucXacAdminController {
  constructor() {
    const CONFIG = {
  ...
  /**
   *
   * @returns {GameXucXac5PAdminController}
   */
  static getInstance = () => {
    if (!GameXucXac5PAdminController.instance) {
      GameXucXac5PAdminController.instance = new GameXucXac5PAdminController();
    }
    return GameXucXac5PAdminController.instance;
  };
}
module.exports = GameXucXac5PAdminController.getInstance();
